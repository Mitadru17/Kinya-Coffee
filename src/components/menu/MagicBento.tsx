...
const DEFAULT_GLOW_COLOR = '217, 124, 91'; // Terracotta
...
const cardData: BentoCardProps[] = [
  {
    color: '#2C241B',
    title: 'Cortado',
    description: 'Perfect balance of espresso and steamed milk • Single origin Ethiopian beans',
    label: '01',
  ...
  },
  {
    color: '#2C241B',
    title: 'Cold Brew',
    description: 'Slow-steeped for 16 hours • Smooth, naturally sweet with chocolate notes',
    label: '02',
  ...
  },
  {
    color: '#2C241B',
    title: 'Pour Over',
    description: 'Meticulously hand-poured • Highlighting complex flavor profiles',
    label: '03',
  ...
  },
  {
    color: '#2C241B',
    title: 'Espresso',
    description: 'Bold, concentrated shot • Caramel sweetness with a velvety crema',
    label: '04',
  ...
  },
  {
    color: '#2C241B',
    title: 'Cappuccino',
    description: 'Equal parts espresso, steamed milk & foam • Italian tradition perfected',
    label: '05',
  ...
  },
  {
    color: '#2C241B',
    title: 'Latte',
    description: 'Silky microfoam meets rich espresso • Canvas for latte art',
    label: '06',
        ...
        {cardData.map((card, index) => {
          ...
          if (enableStars) {
            return (
              ...
              >
                {card.image && (
                  <div className="magic-bento-card__image" style={{ backgroundImage: `url(${card.image})` }} />
                )}
                ...
                <div className="magic-bento-card__content">
                  ...
                  <div className="card-footer">
                    <span className="price-tag">$4.50</span>
                    <span className="hover-indicator">EXPLORE →</span>
                  </div>
                </div>
              </ParticleCard>
            );
